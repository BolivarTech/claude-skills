...
|-------|---------|--------------|
| [`humanize`](humanize/) | [1.0.0](humanize/CHANGELOG.md) | Rewrites prose so it reads as written by a person, and says why each thing it removes reads as machine-made |
